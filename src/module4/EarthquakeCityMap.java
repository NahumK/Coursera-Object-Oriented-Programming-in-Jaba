...
public class EarthquakeCityMap extends PApplet
{
	...
	private void addKey()
	{
		...
		fill(color(175, 0, 0));
		int triSize = 9, x = 60, y = 100;
		float delta = triSize / 2;
		float xA = x - delta;
		float yA = y + delta;
		float xB = x + delta;
		float yB = y + delta;
		...
		int gamma = 6;
		line(60 - gamma, 260 + gamma, 60 + gamma, 260 - gamma);
		line(60 - gamma, 260 - gamma, 60 + gamma, 260 + gamma);
	...
	private void printQuakes() 
	{
		...
		int totalLandQuakes = 0, oceanQuakeCounter = 0;
		...
		oceanQuakeCounter = quakeMarkers.size() - totalLandQuakes;
