...
public class EarthquakeCityMap extends PApplet 
{
	...
	{  
		...
		if(mag < THRESHOLD_LIGHT)
		{
			...
			marker.setRadius(2*PI);
		}
		else if(mag >= THRESHOLD_MODERATE)
		{
			marker.setColor(red);
			marker.setRadius(4*PI);
		}
		else
	...
	{	
		...
		fill(255, 0, 0);
		ellipse(50, 120, 4*PI, 4*PI);	
		fill(255, 255, 0);
		ellipse(50, 160, 3*PI, 3*PI);
		fill(0, 0, 255);
		ellipse(50, 200, 2*PI, 2*PI);
		
		fill(0);
		text("Earthquake Key", 50, 80);
		text("5.0+ Magnitude", 75, 125);
		text("4.0+ Magnitude", 75, 165);
