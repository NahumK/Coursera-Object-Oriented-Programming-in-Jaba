...
public class EarthquakeCityMap extends PApplet 
{
	...
	public void mouseClicked()
	{
		...
		{
			//TODO: determine which marker is being selected
			//(if any) hide /display other markers
			boolean markerCliked = selectMarkerIfClicked(quakeMarkers);
			if(!markerCliked)
				markerCliked = selectMarkerIfClicked(cityMarkers);
			if(markerCliked)
			{
				List<Marker> selectedMarkers = determineVisibleMarkers();
				hideMarkers(selectedMarkers);
			}
	...
	private List<Marker> determineVisibleMarkers()
	{
		List<Marker> result = new ArrayList<Marker>();

		result.add(lastClicked);

		addThreatEntities(result, quakeMarkers);
		addThreatEntities(result, cityMarkers);

		return result;
	}

	private void addThreatEntities(List<Marker> list, List<Marker> markers)
	{
	...
	private void hideMarkers(List<Marker> visibleMarkers)
	{
